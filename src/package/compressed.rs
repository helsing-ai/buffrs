...
impl Package {
    ...
    pub fn create(
        ...
        Self::add_manifest_to_archive(&mut archive, &resolved_manifest, Some(MANIFEST_PREFIX), MANIFEST_FILE)?;
        Self::add_manifest_to_archive(&mut archive, &manifest, None, &format!("{MANIFEST_FILE}.orig"))?;
...
r#"# THIS FILE IS AUTOMATICALLY GENERATED BY BUFFRS
#
